...
async def add_missing_nodes_final():
    """Add POLLLLLL and LOOPPPPP nodes correctly"""
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text("""
            INSERT INTO nodes (id, node_key, device_label, device_type, analytics_type, status, lat, long, location_name, capacity, thingspeak_channel_id, thingspeak_read_api_key, created_at)
            VALUES (
...
if __name__ == "__main__":
    asyncio.run(add_missing_nodes_final())
