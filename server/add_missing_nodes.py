    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text("""
            INSERT INTO nodes (
                ...
                'pol-tank-001', 'POLLLLLL', 'MAIN TANK', 'OverheadTank', 'EvaraTank', 'Online',
                ...
                thingspeak_read_api_key = EXCLUDED.thingspeak_read_api_key,
        ...
        await conn.execute(text("""
            INSERT INTO nodes (
                ...
                'krb-tank-001', 'LOOPPPPP', 'KRB TANK', 'OverheadTank', 'EvaraTank', 'Online',
